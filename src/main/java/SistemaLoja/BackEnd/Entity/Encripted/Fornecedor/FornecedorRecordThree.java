...
public record FornecedorRecordThree(String id, String nome, String cpfOrCnpj, String email, String telefone, String fullAdress,
                                    String codCountry, String codEstado, String codCidade, String codFornecedor) {
    @JsonCreator
    public FornecedorRecordThree(@JsonProperty("id") String id,
